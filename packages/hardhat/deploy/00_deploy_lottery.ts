...
async function initContracts() {
  ...
  const contractFactory: ContractFactory = await ethers.getContractFactory("Lottery");
  contract = (await contractFactory.deploy(
    "LotteryToken",
    "LT0",
    TOKEN_RATIO,
    ethers.utils.parseUnits(BET_PRICE.toFixed(18)),
    ethers.utils.parseUnits(BET_FEE.toFixed(18))
  )) as Lottery;
